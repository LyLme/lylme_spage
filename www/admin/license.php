				...
				<div class="col-lg-12">
					<div class="card">
						...
						<ul class="list-group">
							...
							<li class="list-group-item">授权后点击<a
									href="./update.php">检查更新</a>会自动下发授权密钥，若未自动下发成功需复制粘贴授权秘钥到下方编辑框</li>
							...
							<div class="tab-pane active">
								...
								<form action="license.php?set=save" method="post" name="edit-form" class="edit-form"
									...
									<div class="form-group">
										...
										<input class="form-control" type="text" id="web_site_licensecode" name="licensecode"
											value="<?php echo isset($conf['c']) ? $conf['c'] : '' ?>" placeholder="请输入授权密钥">

										<small
											class="help-block">当前域名：<code><?php $hostmode = isset($conf['hostmode']) ? $conf['hostmode'] : "2";
											echo siteurl($hostmode) ?></code>，若与实际使用域名不符，可在下方切换"域名获取方式切换<br>微信关注【上云六零】公众号免费获取授权，授权后点击<a
												href="./update.php">检查更新</a>会自动下发授权密钥。<a
												href="https://doc.lylme.com/spage/#/license" target="_blank">查看说明</a>
										</small>
									</div>
									<div class="form-group">
										...
										<label class="lyear-radio radio-primary m-t-10">
											...
											if ($hostmode == "1") {
												...
												name="hostmode">
											<span><strong>[模式1_HTTP_HOST]</strong>[<code><?php echo siteurl(1) ?></code>]</span>
										</label>
										<label class="lyear-radio radio-primary m-t-10">
