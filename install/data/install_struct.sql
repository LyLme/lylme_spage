...
(12, 'WorkBuddy', 2, 'https://www.workbuddy.cn/events/invite?inviteCode=wtrszg5cna', '<svg class=\"icon\" aria-hidden=\"true\"><use xlink:href=\"#lyicon-workbuddy\"></use></svg>', 'AI智能助手，高效完成工作与创作任务', 'WorkBuddy,AI助手,智能办公,AI编程', 11, 1, 0),
