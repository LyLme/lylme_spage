...
<?php
	...
	@file_get_contents($domian[1].'://hao.'.$domian[0].'.com/install-tj.php?date='.date('Y-m-d H:i').'&url='.$_SERVER['HTTP_HOST'], false, stream_context_create(array('http'=>array('method'=>"GET",'timeout'=>10))));
